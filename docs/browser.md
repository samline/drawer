...
```html
<link rel="stylesheet" href="https://unpkg.com/@samline/drawer@2.0.7/dist/style.css" />
<script src="https://unpkg.com/@samline/drawer@2.0.7/dist/browser/index.js"></script>
```
