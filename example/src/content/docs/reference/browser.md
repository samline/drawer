...
Use the browser entry when a CDN and a classic script are simpler than a bundler. This page targets the exact `3.1.0` assets.
...
Keep the CSS and JS URLs pinned to the same exact version. These docs intentionally use `@3.1.0`.
:::
