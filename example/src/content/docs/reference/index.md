...
This section documents the `@samline/drawer@4.0.0` public surface and its current runtime behavior. Pages are grouped by configuration, API, types, browser usage, styling, and examples.
...
- [Configuration](/drawer/reference/configuration/) — every `CommonDrawerOptions` and `VanillaDrawerOptions` field, including 4.0.0 defaults and deprecated aliases.
