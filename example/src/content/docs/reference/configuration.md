...
| `fadeFromIndex`             | `number`                                             | last snap index         | First snap index where the overlay is visible. If omitted with snap points, the 3.1.0 release resolves it to `snapPoints.length - 1`.                                                                                                     | `fadeFromIndex: 1`                                                                   |
