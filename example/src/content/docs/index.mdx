...
<CardGrid>
  <Card title="Getting started" icon="pencil-line">
    Install the stable 4.0.0 release, load its stylesheet, and open your first drawer.
  ...
  <Card title="Browser global" icon="seti:html">
    Load the separate 4.0.0 CSS and JS assets, then use `window.Drawer` without a bundler.
